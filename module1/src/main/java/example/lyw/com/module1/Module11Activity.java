...
@Route(path = Module1Constants.ROUTRE_MODULE11)
public class Module11Activity extends BaseActivity {
    private Button btn1;
    private Button btn2;
    private Button btn3;
    private Button btn4;
    ...
    private void initView(){
        ...
        btn1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                bundle.putString("from","从module11跳转来");
        ...
        btn5.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Bundle bundle = new Bundle();
                bundle.putString("from","从module11跳转来");
                ARouter.getInstance().build(Module1Constants.ROUTRE_MODULE12)
                        .with(bundle)
                        .navigation();
            }
        });
