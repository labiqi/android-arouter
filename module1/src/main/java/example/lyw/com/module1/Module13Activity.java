...
@Route(path = Module1Constants.ROUTRE_MODULE13)
public class Module13Activity extends BaseActivity {
    private Button btn1;
    private Button btn2;
    private Button btn3;
    private Button btn4;
    ...
    private void initView(){
        ...
        btn1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                bundle.putString("from","从module13跳转来");
...
//                Bundle bundle = new Bundle();
//                bundle.putString("from","从module13跳转来");
//                ARouter.getInstance().build(Module2Constants.ROUTRE_MODULE12)
//                        .with(bundle)
//                        .navigation();
//            }
//        });
